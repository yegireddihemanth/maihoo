...
# from bson import ObjectId  # 👈 to handle ObjectId conversions
...
# # Allowed frontend origins (exact URLs — no wildcards!)
# origins = [
#     "https://localhost:3443",
#     "https://098b25572723.ngrok-free.app",
#     "http://localhost:3000",
#     "https://localhost:3000",
#     "http://127.0.0.1:3000",
#     "https://a9039689e5b1.ngrok-free.app",
#     "http://10.12.88.79:5001"
# ]

# app.add_middleware(
#     CORSMiddleware,
#     allow_origin_regex="https://.*",   # 👈 allow all HTTPS origins (useful with ngrok)
...
#     # Try to fetch org details if organizationId exists
#     if orgId:
#         try:
#             orgDoc = await orgsCol.find_one({"_id": ObjectId(orgId)})
#         except:
#             orgDoc = await orgsCol.find_one({"_id": orgId})  # fallback if saved as string
...
#     elif user.get("role") == "ORG_HR" and orgDoc:
#         redirectUrl = f"https://{orgDoc.get('subDomain')}/dashboard"
...
#         "organization": (
#             {
#                 "_id": str(orgDoc.get("_id")) if orgDoc else None,
#                 "name": orgDoc.get("organizationName") if orgDoc else None,
#                 "subDomain": orgDoc.get("subDomain") if orgDoc else None
#             } if orgDoc else None
#         ),
...
#             "spocName": org.get("spocName"),
#             "mainDomain": org.get("mainDomain"),
#             "subDomain": org.get("subDomain"),
#             "email": org.get("email"),
#             "gstNumber": org.get("gstNumber"),
...
#             # optional nested SPOC info if available in users collection
#             "spocAccount": await usersCol.find_one(
#                 {"email": org.get("email")},
#                 {"_id": 0, "email": 1, "role": 1, "userName": 1}
#             )
#         })
...
#     # Return full org details back to frontend
#     responseData = {
#         "message": "Organization registered successfully with SPOC account created",
#         "orgId": orgId,
#         "createdBy": user.get("email"),
#         "timestamp": now,
#         "organizationDetails": {
...
#     return JSONResponse(status_code=201, content=responseData)
...
#     """
#     This endpoint allows only SUPER_ADMIN users to update
#     organization (client) details using MongoDB _id.
#     """
...
#     updateData = {key: body[key] for key in validFields if key in body}
...
#         {"_id": object_id},
#         {"$set": jsonable_encoder(updateData)}
#     )
